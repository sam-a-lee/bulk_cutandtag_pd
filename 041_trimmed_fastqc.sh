...
#SBATCH --output=/scratch/prj/bcn_pd_pesticides/Files-From-Imperial/analysis_cutandtag_pd_bulk/data_out/04_trimmed/fastqc/logs/fastqc_%A_%a.out
#SBATCH --error=/scratch/prj/bcn_pd_pesticides/Files-From-Imperial/analysis_cutandtag_pd_bulk/data_out/04_trimmed/fastqc/logs/fastqc_%A_%a.err
...
# get list of samples 
SAMPLES=($(find "${IN_DIR}" -maxdepth 1 -type f -name "*_fastp_polyg_20bp.fq.gz"))
