...
source /users/k2587336/conda/bin/activate /users/k2587336/conda/envs/macs2

# dir with input bed files
IN_DIR="/scratch/prj/bcn_marzi_lab/analysis_cutandtag_pd_bulk/data_out/08_fragments/bedgraphs"
...
BEDGRAPH_FILES=($(find "${IN_DIR}" -maxdepth 1 -type f -name "*_fragments_sorted.bedgraph" | sort))
...
macs2 callpeak \
    ...
    --nomodel \
    --outdir ${OUT_DIR} \
    -n ${SAMPLE_NAME}_macs2_q${threshold}_h3k27ac